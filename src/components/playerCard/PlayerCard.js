                    ...
                    <div className="playerCard-container">
                        <div className="playerCard-content">
                            ...
                            <form className="playerCard-upload-form" onSubmit={sendImage}>
                                <input type="file" id="upload-photo" name="files[]" accept="image/*" onChange={handleImageChange}/>
                                {previewUrl ? <label id="upload-photo-label" htmlFor="upload-photo">Kies een andere foto</label>:
